<nav x-data="{ open: false }" class="bg-gray-800 border-b border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Esencia disponible -->
            <div class="flex items-center text-white text-lg font-medium mr-4">
                <span>Esencia disponible:&nbsp;</span>
                <span class="font-semibold">{{ $esenciaDisponible }}</span>
            </div>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-gray-300 hover:bg-gray-700 focus:outline-none transition duration-150 ease-in-out">
